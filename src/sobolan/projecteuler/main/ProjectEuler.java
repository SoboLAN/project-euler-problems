...
public class ProjectEuler
{
    ...
    private static void fillProblemMap()
    {
        ...
        problemMap.put("21", ProjectEuler21.class);
        problemMap.put("22", ProjectEuler22.class);
        problemMap.put("23", ProjectEuler23.class);
        problemMap.put("24", ProjectEuler24.class);
        problemMap.put("25", ProjectEuler25.class);
        problemMap.put("27", ProjectEuler27.class);
        problemMap.put("28", ProjectEuler28.class);
        problemMap.put("29", ProjectEuler29.class);
        problemMap.put("30", ProjectEuler30.class);
        problemMap.put("32", ProjectEuler32.class);
        problemMap.put("34", ProjectEuler34.class);
        problemMap.put("35", ProjectEuler35.class);
